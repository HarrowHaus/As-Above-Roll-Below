...
export const workApronEffect: EffectDefinition = {id:"gear:work-apron:first-reduction",sourceId:"gear:work-apron",timing:"DAMAGE_MODIFICATION",priority:300,condition:{type:"outcome",value:"loss"},actions:[{type:"reduce_player_damage",value:1}],maxUsesPerEncounter:1};
...
export const floor1EffectRegistry: Readonly<Record<string,EffectDefinition>> = Object.fromEntries([
  bentKnifeEffect,twinNailsEffect,breachingBarEffect,workApronEffect,proofVestEffect,loadedQuestionEffect,falseBottomEffect,oppositeNumberEffect,
