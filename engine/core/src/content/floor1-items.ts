...
const items: ItemDefinition[] = [
  ...
  {id:"inside-out-lining",displayName:"Inside-Out Lining",category:"GEAR",gearSlot:"ARMOR",tier:2,basePrice:8,unique:true,effectSourceIds:["gear:inside-out-lining"]},
  {id:"brass-buckle",displayName:"Brass Buckle",category:"GEAR",gearSlot:"UTILITY",tier:1,basePrice:5,unique:true,effectSourceIds:["gear:brass-buckle"]},
  ...
  {id:"red-thread",displayName:"Red Thread",category:"ARTIFACT",tier:1,basePrice:6,unique:true,effectSourceIds:["artifact:red-thread"]},
